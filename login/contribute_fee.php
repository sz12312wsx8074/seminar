...
if(isset($_POST['confirm'])){ 
	switch ($_FILES['fee']['error']){  
		case 1:  
			...
			exit ("<meta http-equiv=REFRESH CONTENT=0.1;url='contribute_fee.php?th=$th'>");
...
<a class="label label-primary" href="/seminar/login/reset_pwd.php?th=<?php echo $th.'&id='. base64_encode($user); ?>">修改密碼</a>&nbsp;&nbsp;
...
<table class="table table-striped">
  ...
  <tbody>
    <tr>
      ...
      <td>一篇論文&nbsp;&nbsp;<?php echo 'NT$'.$row_data['first_paper'];
          if ($row_data['second_paper'] != 0) {
            echo '<br>二篇以上(含)每篇&nbsp;&nbsp;NT$'.$row_data['second_paper'].'</td>';
          }
        ?>
    </tr>
    <tr>
...
<form class="form-text-size" method="POST" action="contribute_fee.php" enctype="multipart/form-data">
