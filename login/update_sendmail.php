...
$sql_new = "SELECT up_no, upsort_num, up_paper, re_firstName FROM upload, register where up_no = '$no' and register.re_mail = '$using'";
...
$mail->Subject = "=?UTF-8?B?".base64_encode('修改論文')."?="; 
// 信件標題
